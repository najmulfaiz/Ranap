        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group" id="fg_kelas" style="display: {{ old('jenis_tarif_id') == 1 ? 'block' : 'none' }};">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control{{ $errors->has('tarif') ? ' is-invalid' : '' }}" name="tarif" autocomplete="off" value="{{ old('tarif') }}">
                        @if ($errors->has('tarif'))
                            <span class="invalid-feedback" role="alert">
